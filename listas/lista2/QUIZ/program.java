...
public class program{
    private static int quantidadeDePerguntas = 3;
    private static String respostas[] = new String[quantidadeDePerguntas];
    private static String gabarito[] = new String[quantidadeDePerguntas];
